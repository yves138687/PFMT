...
- 已实现：单用户登录、JWT 会话、系统配置、目录树、目录创建、文件列表、文件属性、文件备注、文件上传、流式加密存储、Markdown 解密读取、审计日志、请求/业务/异常日志
- 已实现前端页面：登录页、主布局、顶部导航、左侧目录树、首页、上传页、系统配置页、文件列表页、文件详情页、属性弹窗、Markdown 只读预览
